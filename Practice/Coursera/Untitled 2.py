...
def update_line(line):
    ...
    """
		working_line = lstrip(line)
		if working_line.startswith("<pre class='cm'>") and working_line.endswith("</pre>") == True and working_line.find("print") >0:
			working_line = "print("{}")".format(working_line)
			line = working_line.replace(working_line,[working_line.rindex("print")],"")
...
##docs_updated.html and docs_updated_solution.html are the sam
